    ...
    >
      ...
      >
        <div className="relative">
          <h2 className="text-2xl font-bold mb-6 z-10">Timeline Perjalanan</h2>
          {/* Garis tengah utama */}
          <div className="absolute left-1/2 transform -translate-x-1/2 h-[97%] w-0.5 bg-[#e66814]"></div>
            ...
            >
              ...
              >
                <motion.div
                  ...
                  className="bg-white p-2 rounded-md shadow-sm border border-gray-100 inline-block"
                >
