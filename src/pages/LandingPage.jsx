              ...
              <div className="bg-white/50 flex p-8 rounded-xl w-[85%] md:w-[90%] items-center justify-center">
                ...
                <div className="text-center w-full">
                  ...
                  <div className="flex items-center justify-center gap-3 mb-4">
                    <div className="h-px w-12 bg-[#d1a575]/50" />
                    <div className="w-2 h-2 rounded-full bg-[#d1a575]" />
                    <div className="h-px w-12 bg-[#d1a575]/50" />
                  </div>

                  <h2 className="text-2xl font-bold text-gray-800 leading-tight uppercase mb-4">
                    {config.data.groomName}
                    <span className="text-[#d1a575] mx-2">&</span>
                  ...
                  >
                    ...
                    <p className="bg-[000000]/90 rounded font-bold text-[30px] text-[#d1a575] border-2 border-transparent border-b-black pb-1 px-4 inline-block">
                  ...
                  <motion.button
                    ...
                    className="w-full bg-[#d1a575] text-white px-6 py-2 rounded-lg font-medium hover:bg-[#d87b17] transition-all duration-200"
                  >
