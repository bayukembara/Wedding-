...
const LandingPage = ({ onOpenInvitation }) => (
  ...
  >
    ...
    <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
      ...
      >
        {/* Card Container */}
        <div className="backdrop-blur-sm bg-white/50 p-6 sm:p-8 md:p-10 rounded-2xl border border-sky-100/50 shadow-xl">
          {/* Top Decorative Line */}
          <div className="flex items-center justify-center gap-3 mb-6 sm:mb-8">
            <div className="h-px w-12 sm:w-16 bg-sky-200/50" />
          ...
          >
            <div className="space-y-2">
              <h1 className="text-3xl font-mono sm:text-4xl md:text-5xl text-gray-800 leading-tight uppercase">
                {config.data.groomName}
                <span className="text-sky-400 mx-2 sm:mx-3">&</span>
                {config.data.brideName}
              </h1>
              <div className="h-px w-16 sm:w-24 mx-auto bg-sky-200" />
            </div>
          </motion.div>
          ...
          >
            <motion.button
              ...
              className="group relative w-full bg-sky-500 text-white px-6 py-3 sm:px-8 sm:py-3 rounded-xl font-medium shadow-lg hover:bg-sky-600 transition-all duration-200"
            >
